...
var digit_26085 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_26086__$1 = (vlq >>> (5));
while(true){
if((vlq_26086__$1 > (0))){
var digit_26087__$1 = (digit_26085 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_26087__$1));

var G__26093 = (vlq_26086__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__26094 = (vlq_26086__$1 >>> (5));
digit_26085 = G__26093;
vlq_26086__$1 = G__26094;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_26085));
}
break;
}
...
var G__26107 = i__$1;
var G__26108 = result__$1;
var G__26110 = shift__$1;
i = G__26107;
result = G__26108;
shift = G__26110;
continue;
