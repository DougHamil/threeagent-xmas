...
var G__50128 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__50128;
continue;
} else {
return ch;
...
var vec__50055 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50055,(0),null);
return (match === s);
});
...
var len__4730__auto___50162 = arguments.length;
var i__4731__auto___50163 = (0);
while(true){
if((i__4731__auto___50163 < len__4730__auto___50162)){
args__4736__auto__.push((arguments[i__4731__auto___50163]));

var G__50164 = (i__4731__auto___50163 + (1));
i__4731__auto___50163 = G__50164;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq50090){
var G__50091 = cljs.core.first(seq50090);
var seq50090__$1 = cljs.core.next(seq50090);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50091,seq50090__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__50171__delegate = function (rdr,_){
...
var G__50171 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__50172__i = 0, G__50172__a = new Array(arguments.length -  1);
while (G__50172__i < G__50172__a.length) {G__50172__a[G__50172__i] = arguments[G__50172__i + 1]; ++G__50172__i;}
  _ = new cljs.core.IndexedSeq(G__50172__a,0,null);
} 
return G__50171__delegate.call(this,rdr,_);};
G__50171.cljs$lang$maxFixedArity = 1;
G__50171.cljs$lang$applyTo = (function (arglist__50174){
var rdr = cljs.core.first(arglist__50174);
var _ = cljs.core.rest(arglist__50174);
return G__50171__delegate(rdr,_);
});
